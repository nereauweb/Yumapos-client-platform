...
class CreateApiDingProductsMinimumsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('api_ding_products_minimums', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('api_ding_products_minimums');
    }
}
