...
class AgentController extends Controller
{
	...
	public function userStoreApi(Request $request)
    {
        $request->validate(
            [
                'first_name'             => 'required',
        ...
        try {
			...
			return response()->json(['result' => 'REGISTERED'], 200);
	...
	public function test_api(Request $request)
    {
        ...
        try {        
			...
			return response()->json(['result' => 'Test OK'], 200);

        } catch (\Throwable $th) {
            //throw $th;
			return response()->json(['result' => 'Test KO'], 400);
        }
    }
