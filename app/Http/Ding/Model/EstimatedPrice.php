...
class EstimatedPrice implements ModelInterface, ArrayAccess
{
     ...
     * Sets price
     *
     * @param \App\Http\Ding\Model\Price $price The estimated price for the given criteria
     *
     * @return $this
     */
     ...
     * Sets error_codes
     *
     * @param \App\Http\Ding\Model\Error[] $error_codes ErrorCodes (if any) for processing the batch item with the given BatchItemRef
     *
     * @return $this
     */
