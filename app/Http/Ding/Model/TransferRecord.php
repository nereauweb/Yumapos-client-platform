...
class TransferRecord implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'transfer_id' => '\App\Http\Ding\Model\TransferId',
        'sku_code' => 'string',
        'price' => '\App\Http\Ding\Model\Price',
     ...
     * Gets transfer_id
     *
     * @return \App\Http\Ding\Model\TransferId
     */
     ...
     * Sets transfer_id
     *
     * @param \App\Http\Ding\Model\TransferId $transfer_id Both system and customer identifiers for the specific transfer
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param \App\Http\Ding\Model\Price $price The resulting price of the SendTransfer
     *
     * @return $this
     */
