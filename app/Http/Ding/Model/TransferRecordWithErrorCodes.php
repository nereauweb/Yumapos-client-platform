...
class TransferRecordWithErrorCodes implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'transfer_record' => '\App\Http\Ding\Model\TransferRecord',
        'result_code' => 'int',
     ...
     *
     * @return \App\Http\Ding\Model\TransferRecord
     */
     ...
     *
     * @param \App\Http\Ding\Model\TransferRecord $transfer_record The transfer record that was created as a result of a SendTransfer
     *
     * @return $this
     */
     ...
     * Sets error_codes
     *
     * @param \App\Http\Ding\Model\Error[] $error_codes Any error codes that were returned as part of the SendTransfer or in the case of a Batch `ProcessingMode`              that may have occurred later after the batch was submitted to the Provider.
     *
     * @return $this
     */
