...
class ApiCallMbs extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        $operations = ApiMbsCall::where('created_at','>=',$date_begin)->where('created_at','<=',$date_end)->when($this->sortField, function ($query) {
        ...
        return view('livewire.api-call-mbs', compact('operations', 'date_begin', 'date_end', 'users'));
    }
