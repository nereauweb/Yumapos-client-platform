              ...
              <div class="col-sm-12 col-md-10 col-lg-8 col-xl-6">
                <div class="card">
                    <div class="card-header">
                       <h4>{{ __('coreuiforms.edit') }}: {{ $note->title }} </h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="/notes/{{ $note->id }}">
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <input class="form-control" type="text" placeholder="{{ __('coreuiforms.notes.title') }}" name="title" value="{{ $note->title }}" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" id="textarea-input" name="content" rows="9" placeholder="{{ __('coreuiforms.notes.content') }}" required>{{ $note->content }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <input class="form-control" type="text" placeholder="{{ __('coreuiforms.notes.note_type') }}" name="note_type" value="{{ $note->note_type }}" required>
                                </div>
                            </div>
