...
@section('content')
	<div class="card">
		<div class="card-header">
			<div style="display: flex; justify-content: space-between; align-items: center;">
				...
				<div class="pull-right">
					<a href="{{ url('/admin/package/list') }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="Torna alla lista servizi">
		...
		<div class="card-body">
			{!! Form::open(array('route' => 'admin.package.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
