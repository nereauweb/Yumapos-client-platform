...
<div class="card">
	...
	<div class="card-header">
		<div class="row uk-padding-small">
			{!! Form::open(array('route' => 'admin.package.category.create', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation col-md-6 row uk-padding-small' )) !!}
			{!! csrf_field() !!}
			...
			{!! Form::close() !!}
			{!! Form::open(array('route' => 'admin.package.category.update', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation col-md-6 form-table' )) !!}
			{!! csrf_field() !!}
					<h4>Categorie</h4>
